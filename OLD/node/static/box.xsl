...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="figure">
    ...
    <div class="figure">
      ...
      <img width="800px" src="{concat('drafts/',$number,'.fig',count(preceding-sibling::figure)+1,'.png')}" />
  ...
  <xsl:template match="/">
	...
	<div id="super" ng-controller="BoxController">
	  ...
	  <div class="index_container" ng-if="display_index == true || display_definitions == true || display_login == true" ng-click="hide_all()">
	  </div>
